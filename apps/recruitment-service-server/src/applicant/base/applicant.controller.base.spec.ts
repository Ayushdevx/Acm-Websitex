...
const CREATE_INPUT = {
  areasOfInterest: "exampleAreasOfInterest",
  branch: "exampleBranch",
  createdAt: new Date(),
  currentClubMemberships: "exampleCurrentClubMemberships",
  email: "exampleEmail",
  expectations: "exampleExpectations",
  fullName: "exampleFullName",
  gitHubProfile: "exampleGitHubProfile",
  id: "exampleId",
  linkedInProfile: "exampleLinkedInProfile",
  motivation: "exampleMotivation",
  phoneNumber: 42,
  preferredDepartment: "examplePreferredDepartment",
  previousProjects: "examplePreviousProjects",
  referral: "exampleReferral",
  registrationNumber: "exampleRegistrationNumber",
  technicalSkills: "exampleTechnicalSkills",
  updatedAt: new Date(),
  year: 42,
};
const CREATE_RESULT = {
